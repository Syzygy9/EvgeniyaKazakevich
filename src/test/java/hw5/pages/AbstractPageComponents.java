...
public abstract class AbstractPageComponents {
    ...
    public abstract boolean isCheckboxLogDisplayed(String checkboxName, String status);

    public abstract boolean isRadioLogDisplayed(String radioName);

    public abstract boolean isDropdownLogDisplayed(String dropdownValue);
}